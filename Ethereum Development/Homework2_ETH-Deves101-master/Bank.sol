...
contract Bank {
    ...
    function mint(uint256 coinValue) public isOwner {
        ...
        // emit MintEvent
        emit  MintEvent(msg.sender , coinBalance[msg.sender] , now);
    }
    ...
    function buy(uint256 coinValue) public {
        ...
        require ( coinBalance[owner] >= value , "owner 的 coinBalance 不可小於 value!");

        // require msg.sender 的 etherBalance 不小於 value
        require ( coinBalance[msg.sender] >= value , "etherBalance 不可小於 value!");
    ...
    function transferCoin(address to, uint256 coinValue) public {
        ...
        require ( coinBalance[msg.sender] >= value , "msg.sender 的 coinBalance 不可小於 value!");
